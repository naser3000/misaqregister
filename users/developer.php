...
<div class="row"> <!-- row for Users, Permissions, Pages, Email settings panels -->
	...
	<div class="col-xs-6 col-md-2">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>سطوح دسترسی</strong></div>
	<div class="panel-body text-center"><div class="huge"> <i class='fa fa-lock fa-1x'></i> <?=$level_count?></div></div>
	<div class="panel-footer">
	<span class="pull-left"><a href="admin_permissions.php">مدیریت</a></span>
	<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	<div class="clearfix"></div>
	</div> <!-- /panel-footer -->
	</div><!-- /panel -->
	...
	<div class="col-xs-6 col-md-2">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>صفحه ها</strong></div>
	<div class="panel-body  text-center"><div class="huge"> <i class='fa fa-file-text fa-1x'></i> <?=$page_count?></div></div>
	<div class="panel-footer">
	<span class="pull-left"><a href="admin_pages.php">مدیریت</a></span>
	<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	<div class="clearfix"></div>
	</div> <!-- /panel-footer -->
	</div><!-- /panel -->
...
<div class="row "> <!-- rows for Info Panels -->
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>رخ دادهای امنیتی</strong><span align="right" class="small"><a href="tomfoolery.php"> (دیدن لاگ ها)</a></span></div>
	<div class="panel-body" align="center">
	تعداد<br>
	<h2><?=$tomC?></h2>
	رخ داد امنیتی اتفاق افتاده است
	</div>
	</div><!--/panel-->
