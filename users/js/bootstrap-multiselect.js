!function ($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (this.disabledText.length > 0
                    ...
                    if (this.selectAllNumber) {
                        return this.allSelectedText + ' (' + options.length + ' ) مورد ';
                    }
                    else {
            ...
            nSelectedText: 'مورد انتخاب شد',
            allSelectedText: 'همه انتخاب شد',
            numberDisplayed: 3,
        ...
        buildDropdownOptions: function() {
            ...
            if (this.options.enableCollapsibleOptGroups && this.options.multiple) {
                ...
                $("li.multiselect-all", this.$ul).css('background', '#').css('border-bottom', '1px solid #');
